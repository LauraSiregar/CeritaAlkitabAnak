...
public class DanielActivity extends Activity {
...
public void onCreate(Bundle savedInstanceState) {
	    ...
	    Judul.setText(getString(R.string.djudul));
		
		ImageView Gambar = (ImageView) this.findViewById(R.id.gambar);
	    Gambar.setImageResource(R.drawable.daniel);
		
		// Get the button from the view
		Satu = (TextView) this.findViewById(R.id.satu);
		Satu.setText(getString(R.string.dsatu));
		...
		Dua.setText(getString(R.string.ddua));
		...
		Tiga.setText(getString(R.string.dtiga));
		...
		Button Video = (Button) this.findViewById(R.id.video);
	      ...
	      public void onClick(View view) {
	       Intent intent = new Intent(DanielActivity.this, VidDanielActivity.class);
...
private void playSound(int arg){
	...
	if (arg == 1){
		...
		player = MediaPlayer.create(this, R.raw.dsatu);
	}else if (arg==2){
		Toast.makeText(this, isPlaying, Toast.LENGTH_LONG).show();
		player = MediaPlayer.create(this, R.raw.ddua);
	}else if (arg==3){
		Toast.makeText(this, isPlaying, Toast.LENGTH_LONG).show();
		player = MediaPlayer.create(this, R.raw.dtiga);
	}
