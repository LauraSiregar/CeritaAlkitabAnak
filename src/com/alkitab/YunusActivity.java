...
public class YunusActivity extends Activity {
...
public void onCreate(Bundle savedInstanceState) {
	    ...
	    Judul.setText(getString(R.string.YuJudul));
		
		ImageView Gambar = (ImageView) this.findViewById(R.id.gambar);
	    Gambar.setImageResource(R.drawable.yunus);
		
		// Get the button from the view
		Satu = (TextView) this.findViewById(R.id.satu);
		Satu.setText(getString(R.string.Yusatu));
		...
		Dua.setText(getString(R.string.Yudua));
		...
		Tiga.setText(getString(R.string.Yutiga));
		...
		Button Video = (Button) this.findViewById(R.id.video);
	      ...
	      public void onClick(View view) {
	       Intent intent = new Intent(YunusActivity.this, VidYunusActivity.class);
...
private void playSound(int arg){
	...
	if (arg == 1){
		...
		player = MediaPlayer.create(this, R.raw.yusatu);
	}else if (arg==2){
		Toast.makeText(this, isPlaying, Toast.LENGTH_LONG).show();
		player = MediaPlayer.create(this, R.raw.yudua);
	}else if (arg==3){
		Toast.makeText(this, isPlaying, Toast.LENGTH_LONG).show();
		player = MediaPlayer.create(this, R.raw.yutiga);
	}
