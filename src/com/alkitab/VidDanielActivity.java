...
public class VidDanielActivity extends Activity {
   ...
   private MediaController mediacontroller;
	...
	public void onCreate(Bundle icicle) {
		...
		File clip=new File(Environment.getExternalStorageDirectory(),"Daniel And The Lion's Den Christian Animated Cartoon Movie ).mp4");
